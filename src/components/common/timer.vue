<template>
  <div class="searchTime">
    ...
    <el-date-picker v-model="startTime" type="date" :placeholder="$L.t('annoucement.swtz_4.startTime')" @change="changeTimer()">
    </el-date-picker>
    <span>-</span>
    <el-date-picker v-model="endTime" type="date" :placeholder="$L.t('annoucement.swtz_4.endTime')" @change="changeTimer()">
    </el-date-picker>
  </div>
</template>
<script>
  ...
  methods: {
    ...
    changeTimer() {
      ...
      if (this.startTime && this.endTime) {
        ...
        // 默认加尾数时间
        start = this.timeTool(new Date(this.startTime)) + ' 00:00:00'
        end = this.timeTool(new Date(this.endTime)) + ' 23:59:59'
