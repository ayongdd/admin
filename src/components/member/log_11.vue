<template>
    <div class="container">
          ...
          <tr>
            <td>
              <div class="timeShow">
                ...
                <input type="text" style="width: 100px" v-model="sendParmas.actionIp">
      ...
      <table class="table">
        <tbody>
          ...
          <tr class="odd" v-for="(item,index) in memberStore.dataUserControlLog.data.data">
            <td>{{item.username}}</td>
            <td>{{item.type}}</td>
            <td>{{item.actionIP}}</td>
            <td>{{item.action}}</td>
            ...
            <!--<td>-->
              <!--<button v-if='item.info == 1' @click="checkDetail(item.id)">查看详情</button>-->
            <!--</td>-->
          </tr>
          ...
          <tr v-if="!memberStore.dataUserControlLog.data.data">
  ...
  <script>
    ...
    export default {
      ...
      created (){
        this.getUserControlLog(this.sendParmas)
      ...
      computed: {
        ...
        getPageData () {
          return {
            ...
            sum: this.memberStore.dataUserControlLog.data.count
          }
        }
      },
    }
